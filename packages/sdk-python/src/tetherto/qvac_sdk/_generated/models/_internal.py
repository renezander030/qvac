...
class PluginId(Enum):
    llm = "@qvac/inference/llamacpp-completion/plugin"
    embedding = "@qvac/inference/llamacpp-embedding/plugin"
    whisper = "@qvac/inference/whispercpp-transcription/plugin"
    bci = "@qvac/inference/bci-whispercpp-transcription/plugin"
    nmt = "@qvac/inference/nmtcpp-translation/plugin"
    tts = "@qvac/inference/tts-ggml/plugin"
    ocr = "@qvac/inference/ggml-ocr/plugin"
    diffusion = "@qvac/inference/sdcpp-generation/plugin"
    audiogen = "@qvac/inference/audiogen-ggml/plugin"
    vla = "@qvac/inference/ggml-vla/plugin"
    classification = "@qvac/inference/ggml-classification/plugin"
...
class LoadModelSrcRequestLlamacppCompletion(GeneratedBaseModel):
    ...
    request_id: Annotated[
        ...
        Field(
            alias="requestId",
            description="Stable identifier for this in-flight load, generated by the caller at call time. Optional — falls back to a generated id when the field is missing. Exposed on the decorated promise so callers can target this load with `cancel({ requestId })`.",
            min_length=1,
        ),
    ] = None
