...
The SDK's public API summary (`docs/website/content/docs/sdk/reference/api/index.mdx`) is generated from TypeScript source by a pipeline under `docs/website/scripts/`. To regenerate it locally:

```bash
cd docs/website
npm install
npm run docs:generate-api -- 0.9.1 --latest  # writes content/docs/sdk/reference/api/index.mdx
```
