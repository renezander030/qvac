---
title: "tetherto-qvac-sdk v0.16"
description: "The tetherto-qvac-sdk README as released in sdk-v0.16.0."
---

*The `tetherto-qvac-sdk` README as released in [`sdk-v0.16.0`](https://github.com/tetherto/qvac/releases/tag/sdk-v0.16.0), the SDK release it is stamped from. Every documented version is listed on the [`tetherto-qvac-sdk` index](/platform/inventory/sdk-python).*
...
More in [`examples/`](https://github.com/tetherto/qvac/tree/sdk-v0.16.0/packages/sdk-python/examples) — one runnable example per major capability
...
as numpy. Full examples: [`examples/notebook.ipynb`](https://github.com/tetherto/qvac/blob/sdk-v0.16.0/packages/sdk-python/examples/notebook.ipynb)
(Jupyter) and [`examples/notebook.py`](https://github.com/tetherto/qvac/blob/sdk-v0.16.0/packages/sdk-python/examples/notebook.py) (script).
