---
title: "tetherto-qvac-sdk v0.17"
description: "The tetherto-qvac-sdk README for the 0.17 release of the SDK."
---

*The `tetherto-qvac-sdk` README as it stands on [`main`](https://github.com/tetherto/qvac/tree/main/packages/sdk-python), which is what `sdk-v0.17.0` will carry — that tag has not been cut yet. Every documented version is listed on the [`tetherto-qvac-sdk` index](/platform/inventory/sdk-python).*
...
More in [`examples/`](https://github.com/tetherto/qvac/tree/main/packages/sdk-python/examples) — one runnable example per major capability
...
as numpy. Full examples: [`examples/notebook.ipynb`](https://github.com/tetherto/qvac/blob/main/packages/sdk-python/examples/notebook.ipynb)
(Jupyter) and [`examples/notebook.py`](https://github.com/tetherto/qvac/blob/main/packages/sdk-python/examples/notebook.py) (script).
