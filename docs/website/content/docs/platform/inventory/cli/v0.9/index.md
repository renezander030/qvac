---
title: "@qvac/cli v0.9"
description: "The @qvac/cli README as released in cli-v0.9.0."
---

*The `@qvac/cli` README as released in [`cli-v0.9.0`](https://github.com/tetherto/qvac/releases/tag/cli-v0.9.0). Every documented version is listed on the [`@qvac/cli` index](/platform/inventory/cli).*
...
See [`system-requirements.md`](https://github.com/tetherto/qvac/blob/cli-v0.9.0/packages/cli/system-requirements.md) for the full list of
...
[`test/AGENT_STACK_E2E.md`](https://github.com/tetherto/qvac/blob/cli-v0.9.0/packages/cli/test/AGENT_STACK_E2E.md). It defines which layer owns SDK e2e,
