...
2. [`bciTranscribe()`](/sdk/reference/api#bcitranscribe) or [`bciTranscribeStream()`](/sdk/reference/api#bcitranscribestream)
...
For model artifacts available as constants, see [SDK — Models](/sdk#models).
