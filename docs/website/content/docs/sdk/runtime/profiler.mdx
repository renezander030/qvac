...
See [API — `profiler`](/sdk/reference/api#profiler) for the complete reference, including the full metrics catalog for each export function and detailed usage.
...
[`completion()`](/sdk/reference/api#completion) | [`downloadAsset()`](/sdk/reference/api#downloadasset) | [`embed()`](/sdk/reference/api#embed) | [`invokePlugin()`](/sdk/reference/api#invokeplugin) | [`invokePluginStream()`](/sdk/reference/api#invokepluginstream) | [`loadModel()`](/sdk/reference/api#loadmodel) | [`ocr()`](/sdk/reference/api#ocr) | [`ragChunk()`](/sdk/reference/api#ragchunk) | [`ragCloseWorkspace()`](/sdk/reference/api#ragcloseworkspace) | [`ragDeleteEmbeddings()`](/sdk/reference/api#ragdeleteembeddings) | [`ragDeleteWorkspace()`](/sdk/reference/api#ragdeleteworkspace) | [`ragIngest()`](/sdk/reference/api#ragingest) | [`ragListWorkspaces()`](/sdk/reference/api#raglistworkspaces) | [`ragReindex()`](/sdk/reference/api#ragreindex) | [`ragSaveEmbeddings()`](/sdk/reference/api#ragsaveembeddings) | [`ragSearch()`](/sdk/reference/api#ragsearch) | [`textToSpeech()`](/sdk/reference/api#texttospeech) | [`transcribe()`](/sdk/reference/api#transcribe) | [`transcribeStream()`](/sdk/reference/api#transcribestream) | [`translate()`](/sdk/reference/api#translate)
